...
export const SCENES = {
  my_bedroom_text: {
    ...
    description_en:"A modern bedroom with a tufted dark leather headboard, white split AC, recessed ceiling downlights, a dark wood nightstand with a bedside lamp present, water bottles, chargers and a laptop, charcoal floor-to-ceiling curtains, a dark wood wardrobe with mirrored doors and open clothes shelves, a dark wood dresser with mirror, beige porcelain floor, a large area rug, a grey sofa, ordinary daily clutter, scattered shoes, a chair with clothes, a bag on the floor, and slightly unmade grey bedding."
  },
  bedroom: {
...
export const HAIR_DENSITY_LOCK =
  "HAIR DENSITY LOCK: preserve the exact hairline, original visible hair density, visible scalp, recession pattern and natural strand coverage from the single reference image. Styling may only rearrange existing hair; never fill gaps, thicken hair, add volume, lower the hairline or invent new strands.";
...
export const SELFIE_POSES = [
  ...
  { value:"lying-right-close", family:"lying", label:"الجانب الأيمن — قريب", scenes:BED, angles:["eye","slight-high","side-close"], compositions:["tight","close"], text:"lying on the right side in a close selfie, right cheek and shoulder showing mild pillow and mattress compression, hair compressed only on the contact side" },
...
export const LIGHTING_OPTIONS = {
  bedroom: {
    night: [
      ...
      { value:"night-bedside-3000", label:"أباجورة 3000K فقط", windowIds:["night-charcoal-closed","night-charcoal-open-dark"], text:"one visible 3000K bedside lamp is the dominant practical source, with soft warm falloff and no hidden frontal fill" },
