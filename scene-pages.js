(function(){
  ...
  function landing(){
    ...
    app.innerHTML=''+
      '<header class="top"><div class="logo">PS</div><div class="brand"><h1>Prompt Studio</h1><p>اختر نوع المشهد أولًا حتى تظهر لك إعداداته فقط</p></div><div class="badge">Browser v3.22</div></header>'+
  ...
  function card(key){var m=MODES[key];return '<a class="sceneHomeCard" href="#'+key+'"><div class="sceneHomeIcon">'+m.icon+'</div><div class="sceneHomeTitle">'+m.title+'</div><div class="sceneHomeDesc">'+m.desc+'</div></a>'}
  ...
  function addPageHeader(mode){
    ...
    var badge=top.querySelector('.badge');if(badge)badge.textContent='v3.22';
    if(!qs('#sceneHomeBtn')){var a=document.createElement('a');a.id='sceneHomeBtn';a.href='#';a.textContent='الرئيسية';a.style='text-decoration:none;color:#fff;border:1px solid var(--line);background:#171d25;border-radius:12px;padding:9px 11px;font-size:12px;font-weight:900;margin-inline-start:6px';top.appendChild(a)}
  ...
  function addContextNotice(mode){
    ...
    var n=document.createElement('div');n.id='sceneModeNotice';n.className='notice';
