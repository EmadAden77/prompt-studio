...
const BODY_SCALE = /His stature reads noticeably above-average|His stature reads noticeably above average-height|Shoulders fill seatback|Shoulder and head height relative to roofline|Camera near eye level at 45–60 cm|Roofline, door and handle scale reads as a genuine 195 cm adult/iu;
...
assert.deepEqual(Object.keys(SECTION_REGISTRY).filter((id) => SECTION_IDS.includes(id)), SECTION_IDS);
