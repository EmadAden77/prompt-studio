...
assert.match(engineGate,/from\s+["']\.\/canonical-v3-phase52-1\.js["']/u,"live engine gate must use Phase 52.1 while Phase 51 remains the visual-QA behavior contract");
...
console.log("Phase 51 visual quality evaluation engine: PASS under Phase 52.1 live gate");
