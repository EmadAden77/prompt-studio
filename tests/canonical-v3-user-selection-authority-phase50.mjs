...
assert.match(engineGate,/from\s+["']\.\/canonical-v3-phase52-1\.js["']/u,"live engine gate must use Phase 52.1 while Phase 50 remains the selection-authority behavior contract");
...
console.log("Phase 50 user selection authority: PASS under Phase 52.1 live gate");
