...
assert.match(colored.prompt, /heavy black cotton T[- ]shirt with dark blue jeans/iu, "full colored top+bottom outfit missing");
...
console.log("✓ Phase 37 master de-conflict passed under Phase 38 English outfit text authority");
