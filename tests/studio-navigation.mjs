...
assert.equal((html.match(/data-studio-section=/gu) || []).length, 10);
assert.match(html, /data-studio-section="carExterior"/u);
assert.match(html, /🚘 سيلفي بجانب السيارة/u);
assert.match(html, /data-studio-section="mirror"/u);
assert.match(html, /🪞 سيلفي المرآة/u);
assert.match(html, /physics-app-v7\.js\?v=20260902-post-processing1/u);
assert.match(html, /id="post-processing-panel"/u);
assert.equal((html.match(/name="postProcessing"/gu) || []).length, 8);
