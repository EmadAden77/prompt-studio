...
assert.match(index, /WIKIPROMPT FIRST · SELFIE FIRST · REALISM CORE/u);
...
assert.match(index, /<script type="module" src="js\/physics-app-v6\.js"><\/script>/u);

const app = readFileSync(resolve(root, "js/physics-app-v6.js"), "utf8");
...
console.log("✓ active WikiPrompt Selfie Studio + Realism Core deployment contract passed");
