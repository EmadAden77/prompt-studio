(function(){
  ...
  window.buildFinal=function(){
    ...
    var extras=[];
    extras.push('BEDROOM-SPECIFIC USER CONTROLS — HIGHEST PRIORITY FOR BEDROOM SCENES. Keep the same bedroom identity, but obey the dedicated bedroom lighting and bedroom clutter controls.');
  ...
  window.buildNegative=function(){
    ...
    var v=(typeof smartValues==='function')?smartValues():(typeof state==='object'?state:{});
    if(!roomScene(v)) return base;
    var x=['ignored bedroom-lighting selection','ignored bedroom-clutter selection','reference-photo lighting overriding selected bedroom lighting','yellow ceiling bulbs in the bedroom','AI-looking clutter','duplicated clutter objects','repeated shoes','repeated bottles','floating clutter objects','pasted-looking objects','chaotic nonsense mess','wrong clutter intensity','wrong bedroom lighting mode'];
